export default function Project() {
    return (
      <main className="min-h-screen bg-gradient-to-r from-[#E2F4F3] to-[#C9D6FF] text-gray-800 p-4">
        <header className="max-w-5xl mx-auto py-8 flex flex-col md:flex-row items-center justify-around">
          <div className="mb-8 md:mb-0">
            ...
            <div className="flex gap-4">
              ...
              <button className="bg-gray-100 text-sm font-semibold px-5 py-3 rounded-full shadow hover:bg-white/100">
                meu currículo
              </button>
            </div>
          </div>
