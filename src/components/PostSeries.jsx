  ...
  return (
    ...
    >
      <p>
        ...
        compartilhar três delas. Todas com um quê de estranhamento, todas sobre
        ...
        <br />
        <br />
        🎁 <strong>Bônus:</strong> <em>The Leftovers (HBO Max):</em> Se 2% da população
        mundial simplesmente desaparecesse, como o mundo lidaria? The Leftovers
        não tenta explicar o fenômeno — e isso é o mais brilhante. Uma série
        sobre ausência, fé e o absurdo da existência. É pesada, sim. Mas vale
        cada minuto.
      </p>
    </PostTemplate>
  );
