  ...
  return (
    ...
    >
      ...
      <p>
        ...
        população mundial simplesmente desaparecesse, como o mundo lidaria? The
        Leftovers não tenta explicar o fenômeno — e isso é o mais brilhante. Uma
        série sobre ausência, fé e o absurdo da existência. É pesada, sim. Mas
        vale cada minuto.
      </p>
    </PostTemplate>
  );
